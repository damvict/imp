...
path(
    "bank-documents/<int:doc_id>/edit-amount/",
    views.edit_bank_document_amount_web,
    name="edit_bank_document_amount",
),
...
path(
    "shipments/<int:shipment_id>/edit-arrival-notice/",
    views.edit_arrival_notice_view,
    name="edit_arrival_notice",
),
