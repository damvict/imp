...
def create_arrival_notice(data, user):
    ...
    with transaction.atomic():
        ...
        shipment = Shipment.objects.create(
            ...
            expected_arrival_date=_to_date(
        ...
        # Get the Arrival Notice phase from the master table
        phase_master = ShipmentPhaseMaster.objects.get(
            phase_code="ARRIVAL_NOTICE"
        )
